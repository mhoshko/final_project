# Generated by Django 2.2.5 on 2020-05-13 18:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UserProfile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='books.UserProfile')),
        ...
        migrations.AddField(
            model_name='book',
            name='UserProfile',
            field=models.ManyToManyField(to='books.UserProfile'),
        ),
        migrations.AddField(
            model_name='book',
            name='genre',
